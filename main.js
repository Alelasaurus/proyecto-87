...
ctx._beginPath();
ctx.__stokeStyle_____ = "grey";
ctx.__LineWidth_____ = 1;
ctx.__rect_____(x=150, y=143, width, height);
ctx.stroke();
...
ctx.LineWidth = 5;
ctx.arc(x=300, y=250, r=40, startAngle=0, endAngle=2);
ctx.stroke();
// De igual forma, crea un círculo verde en la posición 400 y 250
ctx.beginPath();
ctx.strokeStyle = "green";
ctx.LineWidth = 5;
ctx.arc(x=400, y=250, r=40, startAngle=0, endAngle=2);
ctx.stroke();